...
int main(int argc, char *argv[])
{
    ...
    double minimo; // Valor local de los elementos del arreglo
   ...
   double min=99999999.999;
	...
	MPI_Reduce(&min, // Valor local de PI
			   &minimo,  // Dato sobre el que vamos a aplicar la operacion
			   1,	 // Numero de datos que vamos a reducir
			   MPI_DOUBLE,  // Tipo de dato que vamos a operar
			   MPI_MIN,  // Operacion que aplicaremos
	...
	if (rank == 0){
		...
		cout << "El valor minimo de los datos aleatorios es: " << minimo<<endl;
	}
