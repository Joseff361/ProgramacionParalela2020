...
int main(int argc, char *argv[])
{
    ...
    double maximo; // Valor local de los elementos del arreglo
   ...
   double max=0.0;
	...
	MPI_Reduce(&max, // Valor local de PI
			   &maximo,  // Dato sobre el que vamos a aplicar la operacion
			   1,	 // Numero de datos que vamos a reducir
			   MPI_DOUBLE,  // Tipo de dato que vamos a operar
			   MPI_MAX,  // Operacion que aplicaremos
	...
	if (rank == 0){
		...
		cout << "El valor maximo de los datos aleatorios es: " << maximo<<endl;
	}
